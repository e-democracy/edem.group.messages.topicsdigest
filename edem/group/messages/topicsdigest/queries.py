...
class DigestQuery(BaseDigestQuery):
    ...
    def topics_sinse_yesterday(self, siteId, groupId):
        ...
        s.append_whereclause(antpt.c.topic_id == tt.c.topic_id)
        s.append_whereclause(antpt.c.date >= yesterday)
        s.append_whereclause(ontpt.c.topic_id == tt.c.topic_id)
        ...
        s.append_whereclause(ontpt.c.date.in_(sa.select(
                        ...
                        .where(sa.and_(pt.c.topic_id == tt.c.topic_id,
                                pt.c.date >= yesterday))\
                        .group_by(tt.c.topic_id)
                        ))
        ...
        s.append_group_by(tt.c.topic_id)
        s.append_group_by(ltpt.c.user_id)
        s.append_group_by(ltpt.c.body)
        s.append_group_by(ltpt.c.post_id)
        s.append_group_by(ontpt.c.post_id)
        s.append_group_by(tkt.c.keywords)
